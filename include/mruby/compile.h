...
#define STR_FUNC_PROC    0x0400
#define STR_FUNC_LAZYEE_SP  0x0800
...
enum mrb_string_type {
  ...
  str_lazyEE   = (STR_FUNC_PARSING|STR_FUNC_WORD|STR_FUNC_ARRAY|STR_FUNC_EXPAND|STR_FUNC_PROC),
  str_lazyEE_sp= (STR_FUNC_PARSING|STR_FUNC_WORD|STR_FUNC_ARRAY|STR_FUNC_EXPAND|STR_FUNC_PROC|STR_FUNC_LAZYEE_SP),
};
